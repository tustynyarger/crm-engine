      ...
      <div className="crm-fade-up w-full max-w-md rounded-2xl border border-slate-200 bg-white p-5 shadow-2xl">
        ...
        {option === "custom" && (
          <div className="mt-3">
            ...
            <input
            className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 text-sm outline-none focus:border-[#007AFF] focus:ring-2 focus:ring-[rgba(0,122,255,0.25)]"
              id="custom-date"
        ...
        <div className="mt-3">
          ...
          <textarea
            className="mt-1 min-h-20 w-full rounded-lg border border-slate-300 px-3 py-2 text-sm outline-none focus:border-[#007AFF] focus:ring-2 focus:ring-[rgba(0,122,255,0.25)]"
            id="quick-note"
        ...
        <div className="mt-4 flex justify-end gap-2">
          ...
          <button
          className="rounded-lg bg-[#007AFF] px-3 py-2 text-sm font-medium text-white shadow-sm hover:bg-[#0066CC]"
            onClick={handleSave}
            type="button"
          >
            Save
