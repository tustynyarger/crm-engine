...
export default function LocationInput({
  ...
  return (
    <div className="relative" ref={rootRef}>
      <input
        autoFocus={autoFocus}
        className="h-10 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700 outline-none transition focus:border-[#007AFF] focus:ring-2 focus:ring-[rgba(0,122,255,0.25)]"
        onBlur={() => {
          clearBlurTimer();
